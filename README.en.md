...
> Built on [virattt/dexter](https://github.com/virattt/dexter) (18,000+ GitHub stars), incorporating Monte Carlo simulation and Altman Z'' from [JPMorgan Python Training](https://github.com/jpmorganchase/python-training). Japanese stock adaptation with Claude Code integration, RadikabuNavi MCP, and 15 original analysis skills.
...
```
> Analyze Toyota
→ Auto-runs DCF + Altman Z'' + PEG ratio + net-net + SEPA + Dow Theory + Granville + supply-demand + Monte Carlo + correlation
