...
- **PDFレポート出力**: レーダーチャート付きの8軸ビジュアル分析レポートをPDF出力。デジタル庁ダッシュボードガイド準拠のデザイン
...
| **pdf-report** | 8軸分析レポートをPDF出力。レーダーチャート・横棒グラフで可視化。デジタル庁ダッシュボードガイド準拠 |
...
- **ベンジャミン・グレアム**: ネットネット株（正味流動資産価値）・安全余裕の原則
- **ピーター・リンチ**: PEGレシオ・成長株の適正評価
